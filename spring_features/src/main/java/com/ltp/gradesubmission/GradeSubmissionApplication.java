...
public class GradeSubmissionApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		Student[] students = new Student[] {
				new Student("Jimmy Johnes", LocalDate.parse(("1980-07-31"))),
				new Student( "Tom Johnes", LocalDate.parse(("1980-05-01"))),
				new Student( "Rob Johnes", LocalDate.parse(("1980-02-11"))),
				new Student( "Cop Johnes", LocalDate.parse(("1980-03-21")))
		};
